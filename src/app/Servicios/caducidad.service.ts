...
export class CaducidadService {
  ...
  getCatFotosServicios(catfotos: any): Observable<any[]> {
    catfotos.idEmpresa = environment.servidor.TAG_IDEMPRESA;
  ...
  getPromotorServicios(/*idEmpresa:number*/): Observable<any[]> {
    ...
    return this.httpClient.get<any[]>(`${this.PHP_API_SERVER}/CatalogoCaducidad/getPromotorCmbServicio.php?idEmpresa=${environment.servidor.TAG_IDEMPRESA}`);
  }
